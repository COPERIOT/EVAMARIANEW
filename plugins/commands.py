...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            ...
            [
                InlineKeyboardButton('⚡ JOIN ⚡', url=f"https://t.me/coperiot"),
            ],
            [
    ...
    if len(message.command) == 2 and message.command[1] in ["subscribe", "error", "okay", "help"]:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ JOIN ⚡', url='https://t.me/coperiot'),
            InlineKeyboardButton('🤖 UᎮDΛTΞS 🤖', url='https://t.me/coperiot')
            ],[
            InlineKeyboardButton('♻️ HΞLᎮ ♻️', callback_data='help'),
            InlineKeyboardButton('♻️ ΛBOUT ♻️', callback_data='about')
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [ InlineKeyboardButton('JOIN', url='https://t.me/coperiot') ] ] ),
        protect_content=True if pre == 'filep' else False,
        )
